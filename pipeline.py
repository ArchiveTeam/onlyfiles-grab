...
LUA_SHA1 = get_hash(os.path.join(CWD, 'onlyfiles.lua'))
...
class WgetArgs(object):
    ...
    def realize(self, item):
        ...
        for item_name in item['item_name'].split('\0'):
            ...
            if item_type == 'f':
                wget_args.extend(['--warc-header', 'onlyfiles-f: '+item_value])
                wget_args.append('https://onlyfiles.io/f/'+item_value)
            else:
...
project = Project(
    ...
    project_html='''
        ...
        <h2>onlyfiles.io <span class="links"><a href="https://onlyfiles.io/">Website</a> &middot; <a href="http://tracker.archiveteam.org/onlyfiles/">Leaderboard</a></span></h2>
        <p>Archiving Onlyfiles.</p>
    '''
)
